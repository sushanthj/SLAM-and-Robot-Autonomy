...
def compile_video(out_dir):
    ...
    # output video path
    out_video_path = os.path.join(out_dir, 'robotdata1.avi')

    # create dummny list to store each frame
    frames = list(range(1, len(os.listdir(out_dir))))
...
if __name__ == '__main__':
    compile_video('/home/sush/CMU/SLAM-and-Robot-Autonomy/SLAM/Particle Filters/16833_HW1_ParticleFilter_Starter_Code/code/results_3841')